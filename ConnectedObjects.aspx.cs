...
namespace WebDataAccessConnected
{
    public partial class ConnectedObjects : System.Web.UI.Page
    {
        ...
        protected void btnUpdatePara_Click(object sender, EventArgs e)
        {
            ...
            ShowGrid();
            //SqlDbType is a enum
            //value property return string by default so we have to cnvert it when required
        ...
        protected void btnUpdateParameter_Click(object sender, EventArgs e)
        {
            conn.Open();
        ...
        protected void btnDeleteWithPara_Click(object sender, EventArgs e)
        {
            conn.Open();
